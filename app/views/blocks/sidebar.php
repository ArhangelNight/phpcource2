<div class="col-md-4 mb-4">
    <?php if(!isset($_SESSION['_internal_user_info']['user_name'])): ?>
        <!--Auth form -->
    ...
    <?php else: ?>
        ...
        <div class="card mb-4 text-center wow fadeIn">
            <div class="card-header">
                <a href="/my-profile" class="btn btn-primary btn-sm">My profile/ change<i class="fa fa-edit ml-3"></i></a>
            </div>
            <div class="card-body">
                <div class="mx-5 my-5">
                    <img class="rounded-circle img-fluid img-thumbnail" src="<?php echo $_SESSION['_internal_user_info']['user_avatar']?>" alt="..." class="rounded-circle img-thumbnail" width="200px">
                    <!-- --><?/*
              ...
              */?>
                ...
                <h1 class="blue-text mb-4">
                    <?php echo $_SESSION['_internal_user_info']['user_name']?>
                </h1>
